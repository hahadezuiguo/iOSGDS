...
@implementation UIView (Opens)

- (void)startAnimationHeartLayer:(CALayer *)heartLayer
{
    CGFloat duration = 6.0f + arc4random_uniform(10) * 0.1;
    
    //位置动画
    CABasicAnimation *posAnimation =
    [CABasicAnimation animationWithKeyPath:@"position"];
    // -30 30
    CGFloat destination_x = heartLayer.position.x + arc4random_uniform(300) - 30 ;
    
    CGFloat destinaion_y =
    heartLayer.position.y / 4;
